...
# Load the dataset
df = pd.read_csv("model\Yield Prediction\crop_production_karnataka.csv")
...
if len(sys.argv) != 6:
    print("Usage: python script.py <State> <District> <Season> <Crop> <Area>")
    sys.exit(1)

# Get the input parameters as command line arguments
Jstate, Jdistrict, Jseason, Jcrops, Jarea = sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5]
